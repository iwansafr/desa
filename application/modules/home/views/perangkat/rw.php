...
<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <?php foreach ($data as $key => $value): ?>
    	...
    	<a class="nav-item nav-link <?php echo $class ?>" id="nav-<?php echo $key;?>-tab" data-toggle="tab" href="#nav-<?php echo $key;?>" role="tab" aria-controls="nav-<?php echo $key;?>" aria-selected="true"><?php echo strtoupper('KETUA RW '.$key) ?></a>
    	<?php $i++; ?>
    <?php endforeach ?>
  </div> 
</nav>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <table class="table table-hover table-striped" style="font-size: 11px;">
                  ...
                  <tr>
                    <td>jabatan</td>
                    <td>: <?php echo strtoupper($dvalue['jabatan'].' '.$dvalue['rw'])?></td>
                  </tr>
                  <tr>
                    <td>PELANTIK</td>
